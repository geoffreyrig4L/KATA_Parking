...
import com.geoffrey.Vehicules.model.Vehicle;
...
public class ParkingTest {
    ...
    void should_be_park(int nbPlaces){
        Vehicle vehicule = new Vehicle(5,false,false,0, nbPlaces);
    ...
    @Test
    void should_out(){
        Vehicle vehicule = new Vehicle(5,true,true, 10, 10);
    ...
    @Test
    void should_not_out(){
        Vehicle vehicule = new Vehicle(5,false,false, 0, 10);
        String result = Parking.vehiculeOut(vehicule);
    ...
    void should_not_out_because_security(){
        Vehicle vehicule = new Vehicle(5,true,false, 0, 10);
        String result = Parking.vehiculeOut(vehicule);
